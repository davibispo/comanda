            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        @guest  
                        @else
                            <li style="padding-right:5px"><a href="{{route('produtos.create')}}" class="btn btn-outline-dark btn-sm">Cadastrar Item</a></li> 
                            <li style="padding-right:5px"><a href="{{route('produtos.index')}}" class="btn btn-outline-dark btn-sm">Cardápio</a></li> 
                            <li style="padding-right:25px" class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{ route('relatorios.resumido') }}">Relatório por Dia</a>
                                        <a class="dropdown-item" href="{{ route('relatorios.periodo') }}">Relatório por Período</a>
                                    </div>
                                </li> 
                            <li style="padding-right:5px"><a href="{{route('relatorios.index')}}" class="btn btn-outline-dark btn-sm">Meu Histórico</a></li> 
                        @endguest
                    </ul>
